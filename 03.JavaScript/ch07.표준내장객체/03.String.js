...
let fruitsArray = fruits.split(';');                //['사과','배', '감', '포도']
console.log(fruitsArray);                             

// 문자열 일부분(substring)
const today = new Date().toISOString();
console.log(today);
// 2024-01-08T02:06:41.320Z
// 날짜 추출: 2024-01-08
...
console.log(new Date().toLocaleString());            //2024. 1. 8. 오전 11:17:19
...
const str = 'A quick brown fox - 3 - 갈색의 재빠른 여유 the lazy dog - 5 - 게으른 개'
let eng = str.replace(/[A-Z a-z]/g, '');     //영문자와 공백만 남기고 모두 지움       // /표시는 not 이라는 뜻
